...
!! module to define parameter types for all global variables
    ...
    character*20000 :: dump_txt                                     ! dummy variable to use for skipping lines in input files
    ...
    character*fn_len :: hydro_daily_stage_file                      ! file name, with relative path, to hydro/STG.out daily timeseries of stage generated by ICM-Hydro
    character*fn_len :: hydro_daily_tiderange_file                  ! file name, with relative path, to hydro/TRG.out daily timeseries of stage generated by ICM-Hydro
    ...
    real(sp),dimension(:,:),allocatable :: stage_daily              ! Daily mean water surface elevation (stage) for the current year (m NAVD88) - first dimension is day-of-year, second dimension is ICM-Hydro compartment ICMID
    real(sp),dimension(:,:),allocatable :: trg_daily                ! Daily mean tidal range for the current year (m) - first dimension is day-of-year, second dimension is ICM-Hydro compartment ICMID 
    real(sp),dimension(:),allocatable :: wlv_yr                     ! Water level variability for the year, as calculated from tidal range (see 'ICM_pre-proceessing/tidal' Github repo for relationship derivation 
    ...
    ! define variables calculated in subroutine: TREE_ESTABLISHMENT_CONDITIONS
